...
ImmuneGO_Annotated_Genes %>% select(genes) %>% distinct()

#Salvar
write.csv(ImmuneGO_Annotated_GO, file = "ImmuneGO_Annotated_GO_26-2-24_2.csv", row.names = F)
write.csv(ImmuneGO_Annotated_Genes, file = "ImmuneGO_Annotated_Genes_26-2-24_2..csv", row.names = F)
