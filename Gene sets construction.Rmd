...
#Salvar
write.csv(ImmuneGO_Annotated_GO, file = "ImmuneGO_Annotated_GO_14-3-24_2.csv", row.names = F)
saveRDS(ImmuneGO_Annotated_GO, file = "ImmuneGO_Annotated_GO_14-3-24_2.rds")
saveRDS(ImmuneGO_Annotated_Genes, file = "ImmuneGO_Annotated_Genes_14-3-24.rds")
...
TCR_BCR_repertoire = immunego_manual %>% 
...
immunego_manual = immunego_manual %>% 
