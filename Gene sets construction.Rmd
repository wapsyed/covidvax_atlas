...
```{r}
######## Anotação de GOs ########
ImmuneGO_Manual = ImmuneGO_Annotated_Genes_26_2_24 # ImmuneGOs manually annotated by Immune System, Sub-system, and cells
...
```{r}
ImmuneGO_Annotated_unique = ImmuneGO_Annotated_Genes_26_2_24
...
#Salvar
write.csv(ImmuneGO_Annotated_GO, file = "ImmuneGO_Annotated_GO_28-2-24_2.csv", row.names = F)
write.csv(ImmuneGO_Annotated_Genes, file = "ImmuneGO_Annotated_Genes_28-2-24.csv", row.names = F)
