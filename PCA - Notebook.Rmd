...
```{r}
#INPUT
data_genes = nonImmuneGO_Genes 
filename = "nonImmuneGO_Genes"
...
cluster_model <- kmeans(pca_res$x[, 1:2], centers = 4)  # Ajuste o número de clusters conforme necessário
...
ggsave(pca_plot_knn_cluster_marginal, file = paste0(filename, "_KNN_Clustered_labels_Density.png"), width = 8, height = 5)
...
filename_2 = paste0("Immune_GO_genes_PCA_PC1", "_COVID")
