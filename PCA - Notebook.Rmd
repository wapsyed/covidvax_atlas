...
# INPUT
pc = "PC2"
ann_genes = OtherGOs_Annotated_Genes
data_2 =  PC2 %>% 
...
row_ha = HeatmapAnnotation(df = ann_rows_notimmune, 
                            which = "row",
                       col = col_process_notimmune, #col_process_immune / col_process_notimmune 
...
# Input
cvrts_eff_var = c("day", "gse_id", "dose", "prior_infection", "previous_vaccination", "severity", "disease_vac", "regimen", "type" )
...
#Sex ----
pc1_cd3e  = ggplot(PC1_genes_counts) +
  ...
  facet_wrap(vars(vaccine), scales = "free", ncol =5) +
  theme(axis.text.x = element_text(size = 6, color = "black", angle = 45, vjust = 1, hjust = 1))

ggsave(pc1_cd3e, file = "pc1_cd3e.png", width = 20, height = 10)

#Age ----

pc1_cd3e_age  = ggplot(PC1_genes_counts) +
  ...
  facet_wrap(vars(vaccine), scales = "free", ncol =5)
ggsave(pc1_cd3e_age, file = "pc1_cd3e_age.png", width = 20, height = 5)
