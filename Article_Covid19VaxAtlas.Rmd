...
## 4.3. (TERMINAR) Immune and non-immune DEGs
...
write_csv(all_degs_vac_infected_immune, file = here("DGE analysis", "all_degs_p_05_vac_infected_immune.csv"))
```
...
degs_GO = all_degs_p_05_vac_infected %>% 
  ...
  mutate(go_id = if_else(is.na(go_id), "Not mapped", go_id),
         ...
         mapped = if_else(term == "Not mapped", "Not mapped", "Mapped"),
