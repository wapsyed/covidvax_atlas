...
sex_stats = ann_vaccines_samples_participants %>% 
...
down = df %>% 
  ...
  scale_colour_npg() 
  # geom_text_repel(
  #   data = df %>% filter(n_genes < 10 & n_genes_perc > 50),
  #   aes(label = condition),
  #   show.legend = FALSE
  # )
...
```{r fig.height=7, fig.width=15}
ggsave(immune_other_plot_diseaseorvac, file = "immune_other_plot_diseaseorvac.png", width = 15, height = 7)
immune_other_plot_diseaseorvac
```
...
## (TERMINAR) GENES COVID vs. VAXGO com ImmuneGO
