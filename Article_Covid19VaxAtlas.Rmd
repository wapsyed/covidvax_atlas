...
p_vacinfec_pairsplot_set = pairsplot(p_vacinfec,
          components = getComponents(p_vacinfec, c(1:10)),
          triangle = T, 
          trianglelabSize = 12,
          hline = 0, vline = 0,
          ...
          gridlines.minor = FALSE,
          colby = 'set',
          colkey = ann_vaxsig_colors$set,
          title = 'Pairs plot, by atlas set', returnPlot = T,
          plotaxes = FALSE) 
...
p_vacinfec_pairsplot_week = pairsplot(p_vacinfec,
          components = getComponents(p_vacinfec, c(1:10)),
          triangle = T, 
          trianglelabSize = 12,
          hline = 0, vline = 0,
          ...
          gridlines.minor = FALSE,
          colby = 'week',
          colkey = ann_vaxsig_colors$week,
          title = 'Pairs plot, by week', returnPlot = T,
          plotaxes = FALSE)

p_vacinfec_pairsplot_set
p_vacinfec_pairsplot_type
p_vacinfec_pairsplot_disease_vac
p_vacinfec_pairsplot_week
...
p_vacinfec_loadingsplot = plotloadings(p_vacinfec, 
                                       labSize = 3,  
                                       shapeSizeRange = 5,titleLabSize = 22,
                            components = 1:10,
...
library(ggplotify)
library(cowplot)
bottom_row <- plot_grid(p_vacinfec_loadingsplot,
...
#Plot
conflicted::conflicts_prefer(PCAtools::biplot)
biplot(vac_p,labSize = 3, pointSize = 5, 
       colby = 'type',
...
vac_pairsplot_set = pairsplot(vac_p,
          components = getComponents(vac_p, c(1:10)),
          triangle = T, 
          trianglelabSize = 12,
          hline = 0, vline = 0,
...
vac_pairsplot_week = pairsplot(vac_p,
          components = getComponents(vac_p, c(1:10)),
          triangle = T, 
          trianglelabSize = 12,
          hline = 0, 
...
vac_metavars = eigencorplot(vac_p,
             metavars = colnames(vac_metadata), 
             col = c(low = '#4DBBD5FF', mid = "white", high = '#DC0000FF')) 

bottom_row <- plot_grid(vac_loadingsplot,
