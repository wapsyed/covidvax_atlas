...
```{r}
filename = paste0(filename, "_Shared") 
library(maditr)
...
```{r}
filename = "All_covid_BTM_immune_Jaccarddist"
...
patch_immune_specific_filtered =  labels_disease_vac/
  ...
  labels_day/
  dotplot_specific +
  plot_layout(heights = c(0.3, 0.3, 0.3, 0.3, 5),
              guides = 'collect') +
  plot_annotation(title = "GSEA ImmuneGO",
                  subtitle = "Specific processes",
                  theme = theme(legend.position = "bottom",
...
**Input**
filtering genes with corr >99% is best
```{r}
#INPUT
data_genes = ImmuneGO_Genes 
filename = "COVID_Infec_Vac_BTM"
