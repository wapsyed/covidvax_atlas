...
getGEOSuppFiles('GSE189039', makeDirectory = T) # Baixar tabela de counts
...
write_csv(GSE189039_metadata, file = here("raw_data", "GSE189039_metadata.csv")) #Terminar de anotar no excel
...
Metadata: A tabela de counts fornecida pelo estudo é nomeada com o Subject ID + Timepoint e não com o codigo GSM. Por isso, teremos de tratar a tabela de metadados. Além disso, ela não possui a coluna de idade. É possível manipular estes dados no excel.
...
# 9. (TERMINAR) Heatmaps - Genes - ImmuneGO
