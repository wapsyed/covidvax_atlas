...
#GSE201530
gse201530_H_BNT_I_D0 = results(dds, name = "condition_BNT.I..D0._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "BNT-I (D0)")  %>% 
  rownames_to_column("genes")
...
gse201530_H_BNT_I_D2 = results(dds, name = "condition_BNT.I..D2._vs_H..D0.") %>%
  as.data.frame() %>%
  arrange(padj) %>%
  mutate(condition = "BNT-I (D2)") %>% 
  rownames_to_column("genes")
...
gse201530_I_BNT_D5 = results(dds, name = "condition_I.BNT..D5._vs_H..D0.") %>%
  as.data.frame() %>%
  arrange(padj) %>%
  mutate(condition = "I-BNT (D5)") %>% 
  rownames_to_column("genes")


gse201530_H_I_D0 = results(dds, name = "condition_I..D0._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "I (D0)")  %>% 
  rownames_to_column("genes")
...
gse201530_H_I_D2 = results(dds, name = "condition_I..D2._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "I (D2)")  %>% 
  rownames_to_column("genes")

gse201530_H_I_D3 = results(dds, name = "condition_I..D3._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "I (D3)")  %>% 
  rownames_to_column("genes")

gse201530_H_I_D4 = results(dds, name = "condition_I..D4._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "I (D4)")  %>% 
  rownames_to_column("genes")
...
#GSE189039
gse189039_BNT_I_D10_mild = results(dds, name = "condition_BNT.I..D10..mild._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "BNT-I (D10, mild)")  %>% 
  rownames_to_column("genes")

gse189039_BNT_I_D10_severe = results(dds, name = "condition_BNT.I..D10..severe._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "BNT-I (D10, severe)")  %>% 
  rownames_to_column("genes")

gse189039_BNT_I_D26_mild = results(dds, name = "condition_BNT.I..D26..mild._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "BNT-I (D26, mild)")  %>% 
  rownames_to_column("genes")

gse189039_BNT_I_D26_severe = results(dds, name = "condition_BNT.I..D26..severe._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "BNT-I (D26, severe)")  %>% 
  rownames_to_column("genes")

gse189039_BNT_I_D51_severe = results(dds, name = "condition_BNT.I..D51..severe._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "BNT-I (D51, severe)")  %>% 
  rownames_to_column("genes")

gse189039_BNT_I_BNT_D51_mild = results(dds, name = "condition_BNT.I.BNT..D51..mild._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "BNT-I-BNT (D51, mild)")  %>% 
  rownames_to_column("genes")

gse189039_BNT_I_BNT_D51_severe = results(dds, name = "condition_BNT.I.BNT..D51..severe._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "BNT-I-BNT (D51, severe)")  %>% 
  rownames_to_column("genes")

gse189039_I_D10_moderate = results(dds, name = "condition_I..D10..moderate._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "I (D10, moderate)")  %>% 
  rownames_to_column("genes")

gse189039_I_D10_severe = results(dds, name = "condition_I..D10..severe._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "I (D10, severe)")  %>% 
  rownames_to_column("genes")

gse189039_I_D26_moderate = results(dds, name = "condition_I..D26..moderate._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "I (D26, moderate)")  %>% 
  rownames_to_column("genes")

gse189039_I_D26_severe = results(dds, name = "condition_I..D26..severe._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "I (D26, severe)")  %>% 
  rownames_to_column("genes")

gse189039_I_D51_moderate = results(dds, name = "condition_I..D51..moderate._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
  mutate(condition = "I (D51, moderate)")  %>% 
  rownames_to_column("genes")

gse189039_I_D51_severe = results(dds, name = "condition_I..D51..severe._vs_H..D0.") %>% 
  as.data.frame() %>% 
  arrange(padj) %>% 
...
infection_DEGs = bind_rows(
  gse201530_H_BNT_I_D0,
  gse201530_H_BNT_I_D1,
  gse201530_H_BNT_I_D2,
