...
#Import files
ann_vaccines_samples_example <- read_csv(here("Annotations and metadata", "ann_vaccines_samples.csv"))

normalized_counts_example <- readRDS(here("DGE analysis", "all_matrices_normalized_counts.rds")) 
...
ssgsea_gene = normalized_counts_example 
