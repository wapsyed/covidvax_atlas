...
main_go_2 = degs_GO %>% 
  ...
  filter(!str_detect(term_ancestor, "reproductive process|reproductive process|positive regulation of biological process|pigmentation|rhythmic process")) %>% 
...
main_go_2_plot = ggplot(main_go_2) +
 ...
 vars(term_ancestor), scales = "free") +
  ...
  geom_text(aes(label = paste0(n_genes_perc, "% (", n_genes, ")"), y = n_genes_perc), 
