...
COVID-COVID immune genes

```{r}
ImmuneGO_Annotated_Genes
OtherGOs_Annotated_Genes
degs_all_updown
filename = "covid_vaccines_infection_Immunegenes_COVID-COVID_"
...
write.csv(degs_all_updown_covid_immune, file = paste0(filename, "Network.csv"), row.names = F)
write_tsv(degs_all_updown_covid_immune, file = paste0(filename, "Network.tsv"))
