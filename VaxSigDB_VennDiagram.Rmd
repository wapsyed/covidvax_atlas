...
# Subset PBMC and Whole Blood samples
...
*What is the relationship between vaccines?*
...
```{r}
# Determine the overlapping genes between vaccines and use a Fisher's exact test and apply the Benjamini-Hochberg correction 
...
overlap_genes <- function(cond1, cond2, data) {
  ...
  shared_genes <- data.frame(
    ...
    Percentage_shared_cond1 = perentage_shared_cond1,
    Percentage_shared_cond2 = perentage_shared_cond2
  )
...
## ORA VAXGO with IMMUNE GO
*What is the relationship between genes in each dataset regarding immunological processes?*
