...
Tutoriais [Data Camp - PCA Analysis in R](https://www.datacamp.com/tutorial/pca-analysis-r){.uri}
...
ggsave(pca_plot_knn_cluster_marginal, file = paste0(filename, pcas, "_KNN_Clustered_labels_Marginal.png"), width = 8, height = 5)


```

```{r PC2-PC3 scatter plot}
# PC2-PC3 ------
...
pca_plot_knn_cluster = autoplot(pca_res, 
  ...
  xlab("PC1 (58.8%)") +
  ylab("PC2 (10.5%)") +
  scale_color_gradientn(colors = c("blue", "red"), limits = c(0, 20), na.value = "red") +
